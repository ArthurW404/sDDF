...
int zynq_gem_init(volatile struct zynq_gem_regs *regs);
int zynq_gem_setup_mac(volatile struct zynq_gem_regs *regs);
...
int zynq_gem_miiphyread(const char *devname, uchar addr, uchar reg, ushort *val);
int zynq_gem_miiphy_write(const char *devname, uchar addr, uchar reg, ushort val);